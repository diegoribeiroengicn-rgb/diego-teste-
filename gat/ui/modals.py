...
def dialog_prestador(usuario: str, registro: dict[str, Any] | None = None, pode_definir_prioridade: bool = True) -> None:
    ...
    status_anterior = registro.get("status_analise") if editando else None
    erros_campos = validar_at_data_status(num_at, data_analise, status_analise, hold_inicio, hold_fim, status_anterior=status_anterior) if tentativa_pendente else {}
